...
import { capturePicture, getWebcamImages } from '../../Actions/api.actions';
...
export default connect(mapStateToProps, { toggleLoader, changeLoaderText, capturePicture, getWebcamImages })(Webcam);
