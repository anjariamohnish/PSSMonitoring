...
export const ListenerType = Object.freeze({ 'ScreenshotRef': 0, 'WebcamRef': 1, 'BrowserHistoryRef': 2, 'RemoteControlRef': 3, 'triggerRef': 4, 'liveStatusRef': 5 });
export const QuizCategory = [9, 10, 16, 17, 19, 22, 23, 27];
